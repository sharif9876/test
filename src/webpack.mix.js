...
mix.sass('resources/sass/layout_guest.scss', 'public/css');
...
mix.sass('resources/sass/blocks.scss', 'public/css');
...
mix.js('resources/js/sidebar_guest.js', 'public/js');
...
mix.js('resources/js/guestBehaviour.js', 'public/js');
